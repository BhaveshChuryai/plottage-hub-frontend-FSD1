...
export default function PropertyCard({ property, onWishlistToggle, isWishlisted }) {
  ...
  return (
    <div className="card-hover rounded-xl overflow-hidden bg-[#151515] border border-[rgba(201,163,74,0.12)] group flex flex-col h-full">
      {/* Image */}
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute bottom-3 left-3">
          <span className="px-2 py-1 text-[10px] font-semibold rounded bg-[#080808]/70 text-[#C9A34A] border border-[rgba(201,163,74,0.3)] backdrop-blur-sm uppercase tracking-wider">
            {property.type}
          </span>
        </div>
      </div>
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-1 mb-4">
          {property.tags.slice(0, 2).map((tag) => (
            <span key={tag} className="px-2 py-0.5 text-[10px] rounded bg-[rgba(201,163,74,0.08)] text-[#A5A5A5] border border-[rgba(201,163,74,0.12)]">
              {tag}
            </span>
          ))}
        </div>
        ...
        {/* Price & Size */}
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-[rgba(201,163,74,0.1)]">
          <div>
