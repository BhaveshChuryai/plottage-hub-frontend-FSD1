...
import { SlidersHorizontal, X, Search, ChevronDown, Grid3X3, List, Filter } from 'lucide-react';
    ...
    <div>
      ...
      <div className="relative">
        <select
          ...
          className="w-full input-premium px-3 py-2.5 text-sm rounded-lg appearance-none cursor-pointer pr-8"
        >
    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full input-premium px-3 py-2.5 text-sm rounded-lg"
        />
...
export default function ExplorePlots() {
  ...
  const filtered = properties.filter((p) => {
    ...
    const matchSearch = !filters.search || p.title.toLowerCase().includes(filters.search.toLowerCase()) || p.location.toLowerCase().includes(filters.search.toLowerCase());
    ...
    return b.potential - a.potential; // Recommended = by potential
  });
    ...
    <div className="space-y-5">
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full input-premium pl-9 pr-3 py-2.5 text-sm rounded-lg"
          />
        </div>
      </div>
      ...
      {hasActiveFilters && (
        <button
          ...
          className="w-full py-2.5 text-sm text-[#C9A34A] border border-[rgba(201,163,74,0.3)] rounded-lg hover:bg-[rgba(201,163,74,0.05)] transition-all duration-200 flex items-center justify-center gap-2"
        >
  ...
  return (
    <div className="min-h-screen bg-[#080808]">
      ...
      {/* Page Header */}
      <div className="bg-[#0a0a0a] border-b border-[rgba(201,163,74,0.1)] py-12 px-4 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex items-center justify-between mb-6 lg:hidden">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 border border-[rgba(201,163,74,0.3)] text-[#C9A34A] rounded-lg text-sm font-semibold"
          >
        ...
        <div className="flex gap-8">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-24 bg-[#101010] border border-[rgba(201,163,74,0.12)] rounded-xl p-5">
          ...
          <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 sm:ml-auto">
                ...
                <div className="relative">
                  <select
                    ...
                    className="input-premium px-4 py-2 text-sm rounded-lg appearance-none pr-8 cursor-pointer"
                  >
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {filters.location !== 'All' && (
                  <span className="badge-verified flex items-center gap-1.5 px-3 py-1.5 text-xs">
                    {filters.location}
                    <button onClick={() => updateFilter('location', 'All')}><X size={10} /></button>
                  </span>
                )}
                {filters.type !== 'All' && (
                  <span className="badge-verified flex items-center gap-1.5 px-3 py-1.5 text-xs">
                    {filters.type}
                    <button onClick={() => updateFilter('type', 'All')}><X size={10} /></button>
                  </span>
                )}
                {filters.purpose !== 'All' && (
                  <span className="badge-verified flex items-center gap-1.5 px-3 py-1.5 text-xs">
                    {filters.purpose}
                    <button onClick={() => updateFilter('purpose', 'All')}><X size={10} /></button>
                  </span>
                )}
              </div>
            )}
            ...
            {filtered.length === 0 ? (
              <div className="text-center py-24">
                <div className="w-16 h-16 rounded-full bg-[rgba(201,163,74,0.08)] border border-[rgba(201,163,74,0.2)] flex items-center justify-center mx-auto mb-4">
                ...
                <button onClick={clearFilters} className="btn-gold px-6 py-2.5 rounded-lg text-sm font-semibold">
      ...
      {mobileFilterOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-80 max-w-full bg-[#0d0d0d] border-l border-[rgba(201,163,74,0.15)] p-6 overflow-y-auto mobile-menu-open">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-[#F5F5F5] font-semibold flex items-center gap-2">
                <SlidersHorizontal size={16} className="text-[#C9A34A]" /> Filters
              </h3>
              <button onClick={() => setMobileFilterOpen(false)} className="text-[#A5A5A5] hover:text-[#F5F5F5]">
                <X size={20} />
              </button>
            </div>
            <FilterPanel />
            <button
              ...
              className="w-full btn-gold mt-6 py-3 rounded-lg font-semibold text-sm"
            >
